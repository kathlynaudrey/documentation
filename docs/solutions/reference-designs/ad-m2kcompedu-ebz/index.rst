...
- ADALM2000, Analog Discovery, and Arduino UNO R4 plug-in option
- ±12V onboard power supply generators with foldback current limit
- Selectable +3.3V supply sources: Arduino +3.3V rail or onboard local LDO
- Two adjustable DC reference voltage generators, buffered, and output-current limited
- Adjustable DC current-source function
...
.. figure:: Block-Diagram-Converted.png
  :align: center
  :width: 800px
