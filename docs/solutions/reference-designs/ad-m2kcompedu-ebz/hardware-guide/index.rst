...
series, and external M5STACK Display.
...
.. table:: Light sensors IR TX/RX and LDR
   ...
   +====================================================+=================================================+
   | .. image:: light_sensors_ir_ldr_pcb.png            | .. image:: light_sensors_ir_ldr_schematic1.png  |
   |    :align: center                                  |    :align: center                               |
   |    :width: 300px                                   |    :width: 300px                                |   
   |                                                    |                                                 |
   +                                                    +-------------------------------------------------+
   |                                                    | .. image:: light_sensors_ir_ldr_schematic2.png  |
   |                                                    |    :align: center                               |
   |                                                    |    :height: 400px                               |
   |                                                    |                                                 |      
   +----------------------------------------------------+-------------------------------------------------+
...
.. table:: User-Accessible Multi-Turn Potentiometers
   ...
   | PCB View (Location and Connectors)           | Schematic View                                  |
   +==============================================+=================================================+
   | .. image:: user_potentiometers_pcb.png       | .. image:: user_potentiometers_schematics1.png  |
   |    :align: center                            |    :align: center                               |
   |    :width: 300px                             |    :height: 400px                               |
   |                                              |                                                 |
   +                                              +-------------------------------------------------+
   |                                              | .. image:: user_potentiometers_schematics2.png  |
   |                                              |    :align: center                               |
   |                                              |    :width: 300px                                |
   |                                              |                                                 |
   +----------------------------------------------+-------------------------------------------------+
...
.. figure:: main_oled_display_schematic.png
    :align: center
    :width: 800px
